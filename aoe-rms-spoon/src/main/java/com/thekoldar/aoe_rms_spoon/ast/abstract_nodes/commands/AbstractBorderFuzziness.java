...
public abstract class AbstractBorderFuzziness extends AbstractRMSSingleOptionalIntArgumentCommand{
	...
	public SemanticCheckOutput semanticCheck(SemanticCheckInput input) throws AbstractRMSException {
		...
		if (this.getArgumentAsInt(0, input) == 0 && this.hasAtLeastOneSiblingOfTypes(RMSNodeType.TOP_BORDER, RMSNodeType.BOTTOM_BORDER, RMSNodeType.LEFT_BORDER, RMSNodeType.RIGHT_BORDER)) {
