package com.thekoldar.aoe_rms_spoon.versions.common.nodes.sections;
...
public class StandardCliffGeneration extends AbstractCliffGeneration {


	public StandardCliffGeneration() {
		super();
	}
