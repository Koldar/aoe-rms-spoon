 ...
 *
 */
public abstract class AbstractSetLooseGrouping extends AbstractRMSNoArgumentCommand {

	protected AbstractSetLooseGrouping() {
		super(RMSNodeType.SET_LOOSE_GROUPING);
	}
