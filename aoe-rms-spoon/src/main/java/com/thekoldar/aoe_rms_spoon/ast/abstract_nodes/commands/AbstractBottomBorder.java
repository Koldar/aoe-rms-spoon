...
public abstract class AbstractBottomBorder extends AbstractRMSSingleOptionalIntArgumentCommand{

	protected AbstractBottomBorder() {
		super(RMSNodeType.BOTTOM_BORDER);
	}
